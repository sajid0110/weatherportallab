...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    // ফর্মে ইউজারনেম বা ইমেইল যা-ই দিক না কেন, তা আমরা একটি ভ্যারিয়েবলে নিচ্ছি
    $login_input = $_POST['username'] ?? '';
    $password = $_POST['password'] ?? '';

    // পাসওয়ার্ড হ্যাশিং বাদ দেওয়া হয়েছে (যেহেতু আপনি ডেটাবেজে সরাসরি প্লেইন টেক্সট পাসওয়ার্ড রাখছেন)
    
    // 🔍 SQL কোয়েরি আপডেট করা হয়েছে: username অথবা email কলামের সাথে ইনপুট ম্যাচ করানো হচ্ছে
    $sql = "SELECT * FROM users WHERE (username = '$login_input' OR email = '$login_input') AND password = '$password'";
    $query_debug = $sql; 
...
<body>
    ...
    <div class="container" style="max-width: 450px; margin-top: 50px;">
        <div class="card">
            <h2>Staff Login</h2>
            <p style="color: #718096; font-size: 0.9em; margin-bottom: 20px;">Please enter your Username or Email to access the station manager.</p>
            ...
            <form method="POST" action="login.php">
                <div class="form-group">
                    ...
                    <input type="text" name="username" required placeholder="e.g., admin or rafi@gmail.com">
                </div>
                <div class="form-group">
